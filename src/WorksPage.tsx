...
export function WorksNavbar({
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed top-0 ${isRTL ? "right-0" : "left-0"} w-full h-screen bg-brand-bg z-[100] flex flex-col px-6 py-6 pb-8 transition-transform duration-500 ease-in-out md:hidden ${
