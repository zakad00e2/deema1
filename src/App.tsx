...
const Hero = () => {
  ...
  return (
    <section ref={containerRef} className="relative flex h-[100dvh] items-end overflow-hidden bg-brand-dark pt-28 md:pt-32 lg:pt-36">
      <div
      ...
      <div className="max-w-360 mx-auto px-6 md:px-12 relative z-20 flex h-[100dvh] w-full items-end">
